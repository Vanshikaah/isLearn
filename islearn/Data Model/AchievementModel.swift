...
class AchievementDataModel {
    ...
    private func loadDefaultAchievements() -> [Achievement] {
        return [
            Achievement(id: UUID(), achievementId: 1, name: "Sign Learner", description: "Learn 5 Signs!", currentLevel: 1, currentProgress: 0, maxProgress: 5, completionXP: 100),
            ...
            Achievement(id: UUID(), achievementId: 4, name: "Streak Keeper", description: "Maintain 100 streak!", currentLevel: 1, currentProgress: 0, maxProgress: 100, completionXP: 250),
